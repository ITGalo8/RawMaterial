...
const PaymentPending = () => {
  ...
  // Search state (only search bar remains)
  const [searchTerm, setSearchTerm] = useState("");
  ...
  // Filter data based only on search term (all fields)
  const filteredData = useMemo(() => {
    const filtered = purchaseOrders.filter((po) => {
      if (!searchTerm.trim()) return true;
    ...
    return filtered;
  }, [purchaseOrders, searchTerm, itemsPerPage]);
  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen">
      <div className="w-full mx-auto">
        ...
        {/* Search Bar - Only filter element */}
        <div className="bg-white rounded-lg shadow p-3 md:p-4 mb-6">
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1">
              <div className="relative">
            ...
            {searchTerm && (
              <button
                onClick={clearSearch}
                className="inline-flex items-center justify-center px-4 py-2 text-sm border border-transparent rounded-md shadow-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 md:w-auto"
              >
                Clear
              </button>
            )}
        ...
        {filteredData.length === 0 ? (
          ...
          <>
                      ...
                      <React.Fragment key={po.poId}>
                        <tr className="hover:bg-gray-50">
                          <td className="px-4 py-4 whitespace-nowrap">
                            ...
                            <div className="text-xs text-gray-500">
                              Grand: {formatCurrency(po.grandTotal, po.currency)}
                            </div>
                          </td>
                          <td className="px-4 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900">
                          ...
                          <td className="px-4 py-4 whitespace-nowrap">
                            <div className="text-sm">
                              ...
                              <div className="text-red-600 font-medium text-sm">
                                Pending: {formatCurrency(po.pendingAmount, po.currency)}
                              </div>
                            </div>
                          </td>
                          <td className="px-4 py-4 whitespace-nowrap text-sm font-medium">
                            <div className="flex flex-col space-y-2">
                              <button
                                ...
                                className="inline-flex items-center text-blue-600 hover:text-blue-900 text-sm"
                              >
                                {expandedRows.has(po.poId) ? "Hide Items" : "View Items"}
                              </button>
                              {po.paymentStatusFlag === "Pending" && (
                                <button
                                  onClick={() => handleMakePayment(po)}
            ...
            {/* Pagination Controls with Items Per Page */}
            <div className="bg-white rounded-lg shadow px-3 py-3 flex flex-col sm:flex-row items-center justify-between border-t border-gray-200 gap-3">
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-4">
                <button
                  onClick={prevPage}
                  disabled={currentPage === 1}
                  className={`relative inline-flex items-center px-3 py-1 text-sm border border-gray-300 font-medium rounded-md ${
                    currentPage === 1
                      ? "bg-gray-100 text-gray-400 cursor-not-allowed"
                      : "bg-white text-gray-700 hover:bg-gray-50"
                  }`}
                ...
                <div className="hidden sm:flex items-center space-x-1">
                  <button
                    onClick={() => goToPage(1)}
                    disabled={currentPage === 1}
                    className={`px-1.5 py-1 rounded-l border border-gray-300 ${
                  ...
                  <button
                    onClick={prevPage}
                    disabled={currentPage === 1}
                    className={`px-1.5 py-1 border border-gray-300 ${
                      currentPage === 1 ? "text-gray-300 cursor-not-allowed" : "text-gray-500 hover:bg-gray-50"
                    }`}
                  ...
                  <button
                    ...
                    disabled={currentPage === totalPages}
                    className={`px-1.5 py-1 rounded-r border border-gray-300 ${
                      currentPage === totalPages ? "text-gray-300 cursor-not-allowed" : "text-gray-500 hover:bg-gray-50"
                    }`}
