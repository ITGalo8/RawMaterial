...
//         currency: currency,
//         exchangeRate: exchangeRate,
//         warehouseId: selectedWarehouse, // Added warehouseId
//         paymentTerms,
//         deliveryTerms,
//         warranty,
//         contactPerson,
...
//               className="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
//               onClick={handleSubmit}
//               disabled={!selectedCompany || !selectedVendor || !selectedGstType || !selectedWarehouse || (currency !== "INR" && (!exchangeRate || parseFloat(exchangeRate) <= 0))}
//             >
//               {location.state?.reorderData ? 'Create ReOrder' : 'Create Purchase Order'}
//             </button>
//           </div>
