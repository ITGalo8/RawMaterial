  ...
  const handleItemSelect = async (id, itemId) => {
    ...
    if (selectedItemData) {
      ...
      try {
        ...
        const hasHsnCode = selectedItemData.hsnCode && selectedItemData.hsnCode.trim() !== "";
        ...
        try {
          ...
          if (response.data.success) {
            ...
            const apiHasHsnCode = detailedItem.hsnCode && detailedItem.hsnCode.trim() !== "";
                      ...
                      {!editableHsn[item.id] && item.hsnCode && item.hsnCode.trim() !== "" ? (
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`w-full px-4 py-2.5 border ${!item.hsnCode ? 'border-orange-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200`}
                            placeholder="Enter HSN code"
                            required
                          />
