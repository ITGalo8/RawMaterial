...
const PoOrderDetails = () => {
  ...
  // Download as PDF – now with per‑row loading
  const handleDownload = async (poId, poName) => {
    if (!poId) return;

    // Set loading for this specific PO
                        ...
                        <tr className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-2 whitespace-nowrap">
                            <div className="flex space-x-2 items-center">
                              ...
                              {/* Download PDF icon – per row */}
                              <button
                                onClick={() =>
                                  handleDownload(po.id, po.poNumber)
                                }
                                disabled={downloadingPdf[po.id] || false}
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <td className="px-3 py-1.5">
                                            <span
                                              className={`px-2 py-0.5 text-xs font-semibold rounded-full ${isFullyReceived
          ...
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                {modalMessage.text && (
                  <div
                    className={`mb-4 p-2 rounded text-sm ${modalMessage.type === "success"
