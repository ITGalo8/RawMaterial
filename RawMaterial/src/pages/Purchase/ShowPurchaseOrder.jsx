...
//     navigate('/purchase/received-purchase-Stock', {
//       state: {
...
const ShowPurchaseOrder = () => {
  ...
  // Handle navigation to Received Stock page
  const handleReceivedStock = () => {
    if (!selectedOrderDetails) return;
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button 
                      className="px-5 py-2.5 border border-green-300 text-green-700 bg-green-50 rounded-xl hover:bg-green-100 transition-all duration-200 font-medium flex items-center justify-center"
