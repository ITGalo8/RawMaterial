...
//   // Fetch line workers data from API
//   useEffect(() => {
...
//   // Fetch incoming item requests when a worker is selected
//   useEffect(() => {
...
//                     {/* <h4>Request ID: {request.id || 'N/A'}</h4> */}
...
//                     <div className="material-given">
//                       <strong>Material Given:</strong> {request.materialGiven}
//                     </div>
//                   )}
