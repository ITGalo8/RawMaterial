...
//   // Navigate to Create Purchase Order with pre-filled data
...
const PrePoRequestHistory = () => {
  ...
  // 🔽 MODIFIED: Navigate to Create Purchase Order with pre-filled data,
  // including prePoId and a source flag.
  const handleCreatePO = (request) => {
    const vendor = request.vendor || {};
    const items = request.prePoItems || [];
    ...
    const reorderData = {
      ...
      // NEW: include the overall pre‑po request ID and a source flag
      prePoId: request.id,           // or request._id depending on your API
      fromPrePo: true,
    };
